...
func main() {
	...
	flag.StringVar(&migrationContext.OptimizerHints.ResourceGroup, "resource-group", "", "Optional MySQL Resource Group to be used for certain, heavy MySQL queries, eg: exact-rowcount SELECT query, etc. Requires MySQL 8.x+")
